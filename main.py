...
"""
An example of how to use the XMLParser
to append an element to a node in an XML tree.
"""
if __name__ == "__main__":
    # Instantiate the parser and parse an xml file with its default namespace.
    parser = XMLParser(
        "tableIndex.xml", namespace="http://www.sa.dk/xmlns/diark/1.0"
    )
